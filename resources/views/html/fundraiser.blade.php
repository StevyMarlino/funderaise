...
<body>
    <nav>
        <div class="container">
            <div>
              <a href="../index.html"> <img src="{{ asset('logo.png')}}" class="logo"></a>
            </div>
            <div class="navbar">
                <ul>
...
<p>We are a peaceful country that has helped protect nations across
  the globe from Tyrannical governments who oppressed their people, 
  well now its happening to us.</p>
</div>
           ...
           <footer>
            <div class="container3">
                ...
                <div>
                       <p>Fundraise For</p>
                       <ul>
                           <li><a href="../html/html/education.html">Education</a></li>
                           <li><a href="../html/html/medical.html">Medical</a></li>
                       </ul>
                </div>
                <div>
                    <p>How it works</p>
